...
/**
 * Servlet implementation class userDomAirScheduleSearchController
 */
@WebServlet("/search4.ai")
public class userDomAirScheduleSearchController2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userDomAirScheduleSearchController2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ticket!=null && ticket.equals("round")) {
			...
			request.getRequestDispatcher("views/airschedule/userDomReturnSearchPage.jsp").forward(request, response);
		}
		...
		if(ticket!=null && ticket.equals("oneway")) {
			...
			if(userNo!=null) {
				...
				request.getRequestDispatcher("/onewayDom.re").forward(request, response);
			}
			else {
