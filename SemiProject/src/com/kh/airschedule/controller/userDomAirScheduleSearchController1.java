...
/**
 * Servlet implementation class userDomAirScheduleSearchController1
 */
@WebServlet("/search3.ai")
public class userDomAirScheduleSearchController1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userDomAirScheduleSearchController1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/airschedule/userDomOnewaySearchPage.jsp").forward(request, response);
	}
