...
/**
 * Servlet implementation class userDomReservationOnewayController
 */
@WebServlet("/domOneway.rd")
public class userDomReservationOnewayController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userDomReservationOnewayController() {
        super();
