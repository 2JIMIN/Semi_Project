...
/**
 * Servlet implementation class userIntReservationRoundController
 */
@WebServlet("/intRound.rd")
public class userIntReservationRoundController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userIntReservationRoundController() {
        super();
