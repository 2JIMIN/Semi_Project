...
/**
 * Servlet implementation class RecommendationUsertListAreaController4
 */
@WebServlet("/listArea4.re")
public class RecommendationUsertListAreaController4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendationUsertListAreaController4() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recommendation>list = new RecommendationService().listArea4(pi);
		...
		request.getRequestDispatcher("/views/recommendation/user_recListArea4.jsp").forward(request, response);
