...
/**
 * Servlet implementation class RecommendationUsertListAreaController1
 */
@WebServlet("/listArea1.re")
public class RecommendationUsertListAreaController1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendationUsertListAreaController1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recommendation>list = new RecommendationService().listArea1(pi);
		...
		request.getRequestDispatcher("/views/recommendation/user_recListArea1.jsp").forward(request, response);
