...
/**
 * Servlet implementation class RecommendationUsertListAreaController5
 */
@WebServlet("/listArea5.re")
public class RecommendationUsertListAreaController5 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendationUsertListAreaController5() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recommendation>list = new RecommendationService().listArea5(pi);
		...
		request.getRequestDispatcher("/views/recommendation/user_recListArea5.jsp").forward(request, response);
