...
/**
 * Servlet implementation class RecommendationAdminListController
 */
@WebServlet("/adList.re")
public class RecommendationAdminListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendationAdminListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/recommendation/admin_recList.jsp").forward(request, response);
	}
