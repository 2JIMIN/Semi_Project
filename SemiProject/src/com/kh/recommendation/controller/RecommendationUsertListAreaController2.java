...
/**
 * Servlet implementation class RecommendationUsertListAreaController2
 */
@WebServlet("/listArea2.re")
public class RecommendationUsertListAreaController2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendationUsertListAreaController2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recommendation>list = new RecommendationService().listArea2(pi);
		...
		request.getRequestDispatcher("/views/recommendation/user_recListArea2.jsp").forward(request, response);
