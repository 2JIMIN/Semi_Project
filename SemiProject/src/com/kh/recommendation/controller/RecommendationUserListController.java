...
/**
 * Servlet implementation class RecommendationUserListController
 */
@WebServlet("/list.re")
public class RecommendationUserListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendationUserListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String keyField_ = request.getParameter("keyField");
		String keyField = "";
		if(keyField_ != null) {
			keyField = keyField_;
		}
		...
		ArrayList<Recommendation> list = new RecommendationService().pageinfoList(pi);
		...
		request.getRequestDispatcher("views/recommendation/user_recList.jsp").forward(request, response);
	}
