...
/**
 * Servlet implementation class userDomOnewayReservationPageController
 */
@WebServlet("/onewayDom.re")
public class userDomOnewayReservationPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public userDomOnewayReservationPageController() {
        super();
...
request.setCharacterEncoding("UTF-8");
		...
		request.getRequestDispatcher("views/reservation/userDomReservationOneway.jsp").forward(request, response);
	}
