...
/**
 * Servlet implementation class Notice_Admin_BoardListController
 */
@WebServlet("/adminlist.no")
public class Notice_Admin_BoardListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public Notice_Admin_BoardListController() {
        super();
    }
...
//		System.out.println(list);
		...
		request.getRequestDispatcher("/views/notice/admin_noticeMain.jsp").forward(request, response);
	}
