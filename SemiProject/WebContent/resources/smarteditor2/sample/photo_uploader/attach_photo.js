...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL= '/KGG//file_uploader_html5.jsp'
...
// 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 			sUrl  : '/KGG/file_uploader.jsp',	//샘플 URL입니다.
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	        sCallback : '/KGG/resources/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
