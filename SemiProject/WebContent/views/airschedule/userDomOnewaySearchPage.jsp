<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="com.kh.airschedule.model.vo.AirSchedule,java.util.ArrayList"%>
<%
...
<link rel="stylesheet" href="/KGG/resources/css/userDomOnewaySearchPageStyle.css">
</head>
<body>
		...
		<div id="content_2">
			<div id="content_2_1">
				<div id="content_2_1_1">
					<table id="itenary">
						...
						<tr>
							...
							<td align="center"></td>
							<td align="center"></td>
							<td align="center" colspan="2" style="font-size: 22px;">출발
								날짜</td>
							<td align="center" colspan="4" style="font-size: 22px;"
								id="depDate"><%=depDate%></td>
						</tr>
					</table>
					<script>
						$(function() {
							...
							var allDepDate = depYear + "년 " + depMonth + "월 "
									+ depDay + "일";
				...
				<div id="content_2_1_2">
					...
					<form action="<%=contextPath%>/search4.ai" id="flightList" method="post">
