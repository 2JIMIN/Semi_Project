<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="com.kh.admin.model.vo.*,java.util.ArrayList"%>
...
<body>
	...
	<div id="content_2">
	    ...
	    <div id="notice_4">
        	<form action="<%=contextPath%>/reservationChangeGood.re?eno=<%=list.get(0).getEnrollNo()%>&flying=<%=list.get(0).getFlightNo()%>"	method="post">
				<br>
				<div class="scroll">
				...
				<button class="btn" type="button">
 				<a href="<%=contextPath%>/reservationChange.re">예약관리 페이지로 이동</a>
 			</button>
 			<input type="submit" value="예약변경" class="btn" id="reservationChanged">
			</form>
        </div>
	<script>
		$(function() {
			if ($("#reservationNull").is(":empty") == true) {
				$("#reservationChanged").hide();
				// console.log("비어있음");
